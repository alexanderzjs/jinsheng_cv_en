...
\noindent\makefield{\faBookmark}{\textbf{Technique Expert (P7) in Secure Multiparty Computation group of Blockchain Department at Ant Financial (Alibaba Group)} \hfill August 2018 -- April 2019}\\
\smallskip
\setlength\parindent{18pt}
\makefield{\faList}{Research, design and implement HTTP based Oblivious Transfer (OT) protocols.}\\
\makefield{\faList}{Research, design and implement HTTP based Garbled Circuit (GC) protocols.}\\
\makefield{\faList}{Design and implement GC based sigmoid module for privacy-preserving Logistic Regression modeling process.}\\
\makefield{\faList}{Design and implement GC based privacy-preserving GBDT prediction process.}\\
\makefield{\faList}{Research, design and implement Secure Multiparty Computation compiler.}\\
\smallskip

\noindent\makefield{\faBookmark}{\textbf{Software Engineer III in Trust and Identity Management team at Ebay Inc.} \hfill May 2016 -- July 2018}\\
\smallskip
